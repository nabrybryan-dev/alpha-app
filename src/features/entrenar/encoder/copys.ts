...
export const COPY = {
  ...
  "hoja_senalar": "Toca el disco para fijarlo",
  "palancas_senalar_atleta_callado": "Atleta seleccionado · una persona en cuadro",
  "palancas_senalar_atleta_ambiguo": "Dos personas en cuadro. Hay otra persona compitiendo por ser el atleta. Toca a quien entrena: si nos equivocamos, el esqueleto sale impecable y es de otro.",
