...
export interface ExploradorAnatomicoProps {
   ...
   * abajo sigue existiendo y se puede cambiar a mano. Sin dato, neutro.
   */
  sexoInicial?: Sexo
}
...
export function ExploradorAnatomico({
  ...
  // (`sexoInicial`), y si no en el neutro, que es el de siempre; en los dos casos se
  // puede cambiar a mano aquí mismo.
  const [sexo, setSexo] = useState<Sexo>(sexoInicial ?? 'neutro')
