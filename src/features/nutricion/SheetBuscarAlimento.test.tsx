...
/**
 * Corre contra el catálogo real de 1.195 alimentos, no contra un montaje: lo
...
describe('SheetBuscarAlimento', () => {
  ...
  it('el contador dice cuántos hay de los 1.195', async () => {
    pintar()
    await userEvent.type(campo(), 'arroz')
    expect(screen.getByText(/de 1.195 alimentos/)).toBeInTheDocument()
  })
