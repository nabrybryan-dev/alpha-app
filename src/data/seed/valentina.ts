  ...
  return [
    {
      ...
      testPost,
      ejercicios: [
        ej({ id: `e-hip-${sufijo}`, categoria: 'DOMINANTE DE CADERA', nombre: 'Hip thrust con barra', cues: 'Mentón abajo, pelvis en retroversión al bloquear, pausa 1s arriba', prescripcion: '85KG A 10 REPS; 3 SERIES (RIR 2). PROGRESA +5KG VS M21. PAUSA ARRIBA', descansoMin: 3, sets: 3, rango: '(8-12)', repsDiana: 10, rirObjetivo: 2, contenidoDemoId: 'c-bisagra', series: [] }, r(85, 10, 2, 3)),
        ej({ id: `e-rdl-${sufijo}`, categoria: 'DOMINANTE DE CADERA', nombre: 'Peso muerto rumano con barra', cues: 'Cadera atrás, barra pegada al muslo, espalda neutra, estira isquios', prescripcion: '52.5KG A 9 REPS; 3 SERIES (RIR 2). PROGRESA +2.5KG VS M21. RANGO COMPLETO', descansoMin: 3, sets: 3, rango: '(8-10)', repsDiana: 9, rirObjetivo: 2, contenidoDemoId: 'c-bisagra', series: [] }, r(52.5, 9, 2, 3)),
        ej({ id: `e-curlfem-${sufijo}`, categoria: 'AISLAMIENTO', nombre: 'Curl femoral sentado', cues: 'Cadera fija al asiento, controla 3s la excéntrica', prescripcion: '40KG A 12 REPS; 3 SERIES (RIR 1). MISMO PESO VS M21, +1 REP. EXCÉNTRICA LENTA', descansoMin: 2, sets: 3, rango: '(10-14)', repsDiana: 12, rirObjetivo: 1, series: [] }, r(40, 12, 1, 3)),
        ej({ id: `e-bulgara-${sufijo}`, categoria: 'DOMINANTE DE RODILLA', nombre: 'Sentadilla búlgara con mancuernas', cues: 'Torso ligeramente inclinado, rodilla viaja sobre el pie', prescripcion: '14KG A 10 REPS; 2 SERIES (RIR 2). MANTIENE VS M21. GLÚTEO DOMINANTE', descansoMin: 2, sets: 2, rango: '(8-12)', repsDiana: 10, rirObjetivo: 2, contenidoDemoId: 'c-zancada', series: [] }, r(14, 10, 2, 2)),
        ej({ id: `e-abd-${sufijo}`, categoria: 'AISLAMIENTO', nombre: 'Abducción de cadera en máquina', cues: 'Tronco inclinado adelante, apertura máxima controlada', prescripcion: '55KG A 15 REPS; 3 SERIES (RIR 1). PROGRESA +5KG VS M21. PICO 1S', descansoMin: 2, sets: 3, rango: '(12-15)', repsDiana: 15, rirObjetivo: 1, series: [] }, r(55, 15, 1, 3)),
      ],
    },
    {
      id: `s-uppera-${sufijo}`,
      ...
      ejercicios: [
        ej({ id: `e-press-${sufijo}`, categoria: 'EMPUJE HORIZONTAL', nombre: 'Press plano con mancuernas', cues: 'Escápulas atrás y abajo, codos 45°, toca pecho sin rebote', prescripcion: '22.5KG A 9 REPS; 3 SERIES (RIR 2). PROGRESA +2.5KG VS M21. CONTROLA BAJADA', descansoMin: 3, sets: 3, rango: '(8-10)', repsDiana: 9, rirObjetivo: 2, contenidoDemoId: 'c-empuje-h', series: [] }, r(22.5, 9, 2, 3)),
        ej({ id: `e-remo-${sufijo}`, categoria: 'TRACCIÓN HORIZONTAL', nombre: 'Remo en máquina con pecho apoyado', cues: 'Lleva codos atrás y abajo, sin encoger hombros', prescripcion: '45KG A 10 REPS; 3 SERIES (RIR 2). PROGRESA +2.5KG VS M21. PAUSA ATRÁS', descansoMin: 3, sets: 3, rango: '(8-12)', repsDiana: 10, rirObjetivo: 2, contenidoDemoId: 'c-traccion', series: [] }, r(45, 10, 2, 3)),
        ej({ id: `e-militar-${sufijo}`, categoria: 'EMPUJE VERTICAL', nombre: 'Press militar sentada con mancuernas', cues: 'Core firme, sube en línea vertical, no arquees lumbar', prescripcion: '12.5KG A 10 REPS; 3 SERIES (RIR 2). MANTIENE VS M21, BUSCA +1 REP', descansoMin: 3, sets: 3, rango: '(8-12)', repsDiana: 10, rirObjetivo: 2, contenidoDemoId: 'c-empuje-v', series: [] }, r(12.5, 10, 2, 3)),
        ej({ id: `e-jalon-${sufijo}`, categoria: 'TRACCIÓN VERTICAL', nombre: 'Jalón al pecho agarre supino', cues: 'Pecho arriba, lleva la barra a la clavícula, controla el regreso', prescripcion: '42.5KG A 11 REPS; 3 SERIES (RIR 1). PROGRESA +2.5KG VS M21', descansoMin: 2, sets: 3, rango: '(10-12)', repsDiana: 11, rirObjetivo: 1, contenidoDemoId: 'c-traccion', series: [] }, r(42.5, 11, 1, 3)),
        ej({ id: `e-lateral-${sufijo}`, categoria: 'AISLAMIENTO', nombre: 'Elevaciones laterales con mancuernas', cues: 'Codos ligeramente flexionados, sube hasta la horizontal', prescripcion: '7KG A 14 REPS; 3 SERIES (RIR 1). MISMO PESO, TÉCNICA ESTRICTA', descansoMin: 2, sets: 3, rango: '(12-15)', repsDiana: 14, rirObjetivo: 1, series: [] }, r(7, 14, 1, 3)),
      ],
    },
    {
      id: `s-legb-${sufijo}`,
      ...
      ejercicios: [
        ej({ id: `e-prensa-${sufijo}`, categoria: 'DOMINANTE DE RODILLA', nombre: 'Prensa 45° pies altos', cues: 'Pies altos y anchos para sesgo de glúteo e isquio, baja profundo', prescripcion: '140KG A 12 REPS; 3 SERIES (RIR 2). PROGRESA +10KG VS M21', descansoMin: 3, sets: 3, rango: '(10-14)', repsDiana: 12, rirObjetivo: 2, contenidoDemoId: 'c-sentadilla', series: [] }, r(140, 12, 2, 3)),
        ej({ id: `e-pmr-${sufijo}`, categoria: 'DOMINANTE DE CADERA', nombre: 'Peso muerto rumano con mancuernas', cues: 'Mancuernas pegadas a la pierna, cadera muy atrás', prescripcion: '20KG A 12 REPS; 3 SERIES (RIR 2). MANTIENE VS M21. ESTIRAMIENTO MÁXIMO', descansoMin: 2, sets: 3, rango: '(10-12)', repsDiana: 12, rirObjetivo: 2, contenidoDemoId: 'c-bisagra', series: [] }, r(20, 12, 2, 3)),
        ej({ id: `e-curltumb-${sufijo}`, categoria: 'AISLAMIENTO', nombre: 'Curl femoral tumbado', cues: 'Cadera pegada a la máquina, no impulses con lumbar', prescripcion: '35KG A 12 REPS; 3 SERIES (RIR 1). PROGRESA +2.5KG VS M21', descansoMin: 2, sets: 3, rango: '(10-14)', repsDiana: 12, rirObjetivo: 1, series: [] }, r(35, 12, 1, 3)),
        ej({ id: `e-patada-${sufijo}`, categoria: 'AISLAMIENTO', nombre: 'Patada de glúteo en polea', cues: 'Extiende desde el glúteo, aprieta 1s arriba', prescripcion: '15KG A 14 REPS; 3 SERIES (RIR 1). MISMO PESO, +1 REP VS M21', descansoMin: 2, sets: 3, rango: '(12-15)', repsDiana: 14, rirObjetivo: 1, series: [] }, r(15, 14, 1, 3)),
        ej({ id: `e-gemelo-${sufijo}`, categoria: 'AISLAMIENTO', nombre: 'Elevación de gemelo de pie', cues: 'Pausa abajo en estiramiento, sube al máximo', prescripcion: '60KG A 15 REPS; 3 SERIES (RIR 1). MANTIENE. PAUSA ABAJO 2S', descansoMin: 2, sets: 3, rango: '(12-15)', repsDiana: 15, rirObjetivo: 1, series: [] }, r(60, 15, 1, 3)),
      ],
    },
    {
      id: `s-upperb-${sufijo}`,
      ...
      ejercicios: [
        ej({ id: `e-inclinado-${sufijo}`, categoria: 'EMPUJE HORIZONTAL', nombre: 'Press inclinado en multipower', cues: 'Banco a 30°, baja a la parte alta del pecho', prescripcion: '35KG A 9 REPS; 3 SERIES (RIR 2). PROGRESA +2.5KG VS M21', descansoMin: 3, sets: 3, rango: '(8-10)', repsDiana: 9, rirObjetivo: 2, contenidoDemoId: 'c-empuje-h', series: [] }, r(35, 9, 2, 3)),
        ej({ id: `e-remobarra-${sufijo}`, categoria: 'TRACCIÓN HORIZONTAL', nombre: 'Remo con barra torso inclinado', cues: 'Torso 45°, tira al ombligo, sin balanceo', prescripcion: '40KG A 10 REPS; 3 SERIES (RIR 2). MANTIENE VS M21, TÉCNICA', descansoMin: 3, sets: 3, rango: '(8-12)', repsDiana: 10, rirObjetivo: 2, contenidoDemoId: 'c-traccion', series: [] }, r(40, 10, 2, 3)),
        ej({ id: `e-facepull-${sufijo}`, categoria: 'TRACCIÓN HORIZONTAL', nombre: 'Face pull en polea alta', cues: 'Tira hacia la frente, rota externo al final', prescripcion: '25KG A 15 REPS; 3 SERIES (RIR 2). SALUD DE HOMBRO, CONTROLADO', descansoMin: 2, sets: 3, rango: '(12-15)', repsDiana: 15, rirObjetivo: 2, series: [] }, r(25, 15, 2, 3)),
        ej({ id: `e-curl-${sufijo}`, categoria: 'AISLAMIENTO', nombre: 'Curl de bíceps en banco inclinado', cues: 'Hombro atrás, estira abajo por completo', prescripcion: '8KG A 12 REPS; 2 SERIES (RIR 1). PROGRESA +1KG VS M21', descansoMin: 2, sets: 2, rango: '(10-12)', repsDiana: 12, rirObjetivo: 1, series: [] }, r(8, 12, 1, 2)),
        ej({ id: `e-triceps-${sufijo}`, categoria: 'AISLAMIENTO', nombre: 'Extensión de tríceps en polea con cuerda', cues: 'Codos fijos al torso, abre la cuerda abajo', prescripcion: '20KG A 12 REPS; 2 SERIES (RIR 2). MANTIENE VS M21', descansoMin: 2, sets: 2, rango: '(10-14)', repsDiana: 12, rirObjetivo: 2, series: [] }, r(20, 12, 2, 2)),
      ],
    },
    {
      id: `s-fullc-${sufijo}`,
      ...
      ejercicios: [
        ej({ id: `e-goblet-${sufijo}`, categoria: 'DOMINANTE DE RODILLA', nombre: 'Sentadilla goblet', cues: 'Codos dentro de las rodillas abajo, torso erguido', prescripcion: '20KG A 12 REPS; 3 SERIES (RIR 2). MANTIENE. PROFUNDIDAD COMPLETA', descansoMin: 2, sets: 3, rango: '(10-14)', repsDiana: 12, rirObjetivo: 2, contenidoDemoId: 'c-sentadilla', series: [] }, r(20, 12, 2, 3)),
        ej({ id: `e-pressmaq-${sufijo}`, categoria: 'EMPUJE HORIZONTAL', nombre: 'Press de pecho en máquina', cues: 'Ajusta asiento a la mitad del pecho, recorrido completo', prescripcion: '35KG A 12 REPS; 3 SERIES (RIR 2). PROGRESA +2.5KG VS M21', descansoMin: 2, sets: 3, rango: '(10-12)', repsDiana: 12, rirObjetivo: 2, contenidoDemoId: 'c-empuje-h', series: [] }, r(35, 12, 2, 3)),
        ej({ id: `e-jalonneutro-${sufijo}`, categoria: 'TRACCIÓN VERTICAL', nombre: 'Jalón agarre neutro', cues: 'Codos hacia el bolsillo, sin balanceo del torso', prescripcion: '40KG A 12 REPS; 3 SERIES (RIR 2). MANTIENE VS M21', descansoMin: 2, sets: 3, rango: '(10-12)', repsDiana: 12, rirObjetivo: 2, contenidoDemoId: 'c-traccion', series: [] }, r(40, 12, 2, 3)),
        ej({ id: `e-lateralpolea-${sufijo}`, categoria: 'AISLAMIENTO', nombre: 'Elevación lateral en polea', cues: 'Cable por detrás del cuerpo, sube al plano escapular', prescripcion: '5KG A 15 REPS; 2 SERIES (RIR 1). TENSIÓN CONTINUA', descansoMin: 2, sets: 2, rango: '(12-15)', repsDiana: 15, rirObjetivo: 1, series: [] }, r(5, 15, 1, 2)),
        ej({ id: `e-core-${sufijo}`, categoria: 'CORE', nombre: 'Plancha con carga', cues: 'Glúteo apretado, no dejes caer la cadera, respira', prescripcion: '40 SEG; 3 SERIES. +5KG EN ESPALDA VS M21', descansoMin: 1, sets: 3, rango: '(30-45s)', repsDiana: 40, rirObjetivo: 2, series: [] }, r(5, 40, 2, 3)),
      ],
    },
  ]
}
